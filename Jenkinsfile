pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/codyivymiamioh/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('ivyca-225')   // <---- Change this to match your kubernetes cluster credentials
    }
